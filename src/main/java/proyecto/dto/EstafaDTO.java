...
public class EstafaDTO {
    ...
    public EstafaDTO(Estafa e) {
        ...
        this.nicknameUsuario = e.getUsuario().getNicknameUsuario();
        this.estado = e.getEstadoEstafa().getNombreEstadoEstafa();
    }
